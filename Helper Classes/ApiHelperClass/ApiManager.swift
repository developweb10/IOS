 ...
 class ApiManager: NSObject {
    ...
    func requestPOSTFormDataURL(_ strURL : String, params : [String : AnyObject]?, headers : [String : String]?, success:@escaping (JSON) -> Void, failure:@escaping (String) -> Void){
    ...
    func requestTwoMultiPartURL(_ strURL : String, params : [String : AnyObject]?, headers : [String : String]? , imagesArray : [UIImage], imageName: [String],videoImage: UIImage, videoImageName: String, success:@escaping (JSON) -> Void, failure:@escaping (String) -> Void){
    ...
    func requestMultiPartImageURL(_ strURL : String, params : [String : AnyObject]?, headers : [String : String]? , imagesArray : [UIImage], imageName: String,  success:@escaping (JSON) -> Void, failure:@escaping (String) -> Void){
        Alamofire.upload(multipartFormData: { (multipartFormData) in
            if imagesArray.count != 0 {
                let formatter = DateFormatter()
                formatter.dateFormat = "MM_dd_yy_HH:mm:ss.SS"
 ...
 extension UIImage {
    ...
    func compressImageToData() -> Data? {
        ...
        let imageData = (img ?? #imageLiteral(resourceName: "imgPlaceholder")).jpegData(compressionQuality: compressionQuality)
